...
Design language: premium / minimal, warm dark. Soft mint is the single accent
(lavender in support); surfaces are near-flat with hairline borders; typography
(Outfit display, Inter UI, DM Mono meta) carries the hierarchy — smooth, not neon.
...
# Validated (dataviz six checks, dark surface #121016): lightness band,
...
<style>
    ...
    :root {{
        ...
        --bg: #121016;
        --ink: #f2efea;
        --muted: rgba(242,239,234,0.58);
        --faint: rgba(242,239,234,0.40);
    ...
    .stApp {{
        background:
            radial-gradient(1100px 520px at 50% -280px, rgba(94,234,212,0.06), transparent 70%),
            var(--bg);
    ...
    .sb-brand {{
        font-family: 'Outfit', sans-serif; font-weight: 800; font-size: 1.12rem;
    ...
    .sb-brand .disc {{
        ...
        background: conic-gradient(from 0deg, var(--accent), var(--accent-2), #f2a6c9, #f5d98f, var(--accent));
    }}
    .sb-section {{
    ...
    .sb-status b {{ color: var(--accent); font-family: 'DM Mono', monospace; }}
    ...
    .metric-card:hover {{ transform: translateY(-2px); border-color: rgba(94,234,212,0.3); }}
    ...
    .metric-sub {{ color: var(--accent); font-size: 0.85rem; margin-top: 0.35rem; font-family: 'DM Mono', monospace; }}
    ...
    .playlist-card:hover {{ border-color: rgba(94,234,212,0.3); background: var(--surface-2); }}
    .playlist-order {{
    ...
    .playlist-meta {{ color: var(--muted); font-size: 0.84rem; margin-top: 0.28rem; font-family: 'DM Mono', monospace; }}
    ...
    .camelot-a {{ background: rgba(167,139,250,0.16); color: #d8b4fe; border: 1px solid rgba(167,139,250,0.3); }}
    .camelot-b {{ background: rgba(94,234,212,0.14); color: #7fffe8; border: 1px solid rgba(94,234,212,0.3); }}
    ...
    .score-pill.good {{ color: #7fffe8; background: rgba(94,234,212,0.1); }}
    ...
    .setup-steps b {{
        font-family: 'Outfit', sans-serif; font-size: 1.02rem; color: var(--accent);
        margin-right: 0.4rem;
    }}
    ...
    .disc-card:hover {{ border-color: rgba(94,234,212,0.28); }}
    ...
    .disc-chip.good {{ color: #7fffe8; background: rgba(94,234,212,0.1); }}
    ...
    .app-brand .disc {{
        ...
        background: conic-gradient(from 0deg, {ACCENT}, {ACCENT_2}, #f2a6c9, #f5d98f, {ACCENT});
    }}
    .app-brand .crumb {{
        color: var(--faint); font-weight: 400; font-size: 0.9rem;
        font-family: 'DM Mono', monospace; margin-left: 0.35rem;
    }}
    .app-header-rule {{
...
<style>
    ...
    .st-key-lp_nav div[data-testid="stButton"] > button {{ border-radius: 999px; }}
    ...
    .lp-hero-note {{
        ...
        font-family: 'DM Mono', monospace; font-size: 0.76rem; letter-spacing: 0.03em;
    }}
    ...
    .feature-card:hover {{ transform: translateY(-3px); border-color: rgba(94,234,212,0.3); }}
    ...
    .preview-frame {{
        ...
        background: linear-gradient(180deg, #16131c, #131019);
    ...
    .preview-bar .u {{
        margin-left: 0.6rem; font-family: 'DM Mono', monospace; font-size: 0.72rem; color: var(--faint);
    }}
    ...
    .pv-row .bp {{ font-family: 'DM Mono', monospace; font-size: 0.7rem; color: var(--faint); }}
    .pv-pill {{
        font-family: 'DM Mono', monospace; font-size: 0.66rem; font-weight: 600;
    ...
    .pv-panel .cap {{
        font-family: 'DM Mono', monospace; font-size: 0.64rem; letter-spacing: 0.14em;
    ...
    .price-card.featured {{
        border-color: rgba(94,234,212,0.45);
        background: linear-gradient(180deg, rgba(94,234,212,0.05), var(--surface));
    }}
    .price-tag {{
        font-family: 'DM Mono', monospace; font-size: 0.62rem; letter-spacing: 0.16em;
        text-transform: uppercase; color: var(--accent);
        border: 1px solid rgba(94,234,212,0.3); border-radius: 999px;
        padding: 0.12rem 0.5rem; align-self: flex-start; margin-bottom: 0.7rem;
    }}
    .price-name {{ font-family: 'Outfit', sans-serif; font-weight: 700; font-size: 1.2rem; color: var(--ink); }}
    .price-amount {{ margin: 0.6rem 0 0.1rem; }}
    .price-amount .a {{ font-family: 'Outfit', sans-serif; font-weight: 800; font-size: 2.4rem; color: var(--ink); letter-spacing: -0.02em; }}
    .price-amount .p {{ color: var(--faint); font-size: 0.9rem; font-family: 'DM Mono', monospace; }}
    ...
    .compare .col h5 {{
        font-family: 'DM Mono', monospace; font-size: 0.7rem; letter-spacing: 0.16em;
    ...
    .lp-footer {{
        ...
        background:
            radial-gradient(ellipse 60% 130% at 50% 0%, rgba(94,234,212,0.08), transparent 60%),
            linear-gradient(180deg, #0b0b12, #131019);
    }}
...
<style>
    ...
    .setup-title {{
        font-family: 'Outfit', sans-serif; font-weight: 800; font-size: 1.9rem; color: var(--ink);
    ...
    .mix-card:hover {{ border-color: rgba(94,234,212,0.28); }}
    .mix-name {{ color: var(--ink); font-size: 0.92rem; flex: 1; }}
    .mix-score {{ font-family: 'DM Mono', monospace; font-weight: 600; color: var(--accent); }}
    ...
    .prem-badge {{
        ...
        padding: 0.15rem 0.5rem; border-radius: 999px; color: #121016;
